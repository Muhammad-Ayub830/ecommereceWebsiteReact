  ...
  return (
    ...
    <Link to='/'>  <img src={assets.logo} className='w-36'/></Link>
      ...
      <div className="flex items-center gap-6">
        <img onClick={()=>setShowSearch((prev)=>!prev)} src={assets.search_icon} className='w-5 cursor-pointer' />
        <div className="group relative">
          <Link to={'/login'}> <img src={assets.profile_icon} className='w-5 cursor-pointer' alt="" /></Link> 
            <div className="group-hover:block group hidden absolute dropdown-menu right-0 pt-4">
        ...
        <Link to='/cart' className='relative'>
            ...
            <p className='absolute right-[-5px] bottom-[-5px] w-4
             text-center leading-4 bg-black text-white
